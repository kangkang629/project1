  ...
  <div>
    ...
    <div class="left-flex">
      <div class="title flex-view">
        <h3>{{ lang.orderdetail[this.$store.state.language] }}</h3>
      </div>
        ...
        <div class="list">
          <div class="items flex-view">
            ...
            <a-input-number v-model="count" :min="1" :max="10" @change="onCountChange"/>
              <img src="@/assets/images/delete-icon.svg" class="delete" @click="handleBack()">
          </div>
        </div>
      </div>
      <div class="title flex-view">
...
import {createApi, deliveryApi} from '@/api/index/order'
