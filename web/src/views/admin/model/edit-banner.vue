<template>
  <a-form-model
    ...
    <a-row :gutter="24">
      ...
      <a-col span="24">
        <a-form-model-item :label=lang.relategoods[this.$store.state.language] prop="thing">
          <a-select :placeholder=lang.plsenter[this.$store.state.language] allowClear v-model="form.thing">
