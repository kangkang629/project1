...
from myapp.views.admin import user, tag, classfication, notice, errorLog, loginLog, \
    opLog, ad, record, banner, order, comment, thing, overview
from myapp.views.views.index import cart
...
urlpatterns = [
    ...
    path('admin/classification/list', views.admin.classfication.list_api),
    path('admin/classification/create', views.admin.classfication.create),
    path('admin/classification/update', views.admin.classfication.update),
    path('admin/classification/delete', views.admin.classfication.delete),
    ...
    path('admin/adminLogin', views.admin.user.login),
    ...
    path('index/order/delivery', views.index.order.delivery),
    ...
    path('index/cart/list', cart.list_api),
    path('index/cart/create', cart.create),
    path('index/cart/update', cart.update),
    path('index/cart/delete', cart.delete),
]
